...
# GRADING VERSION
#
# This is a modified version of media.py to be used for autograding.
# It requires 2 command line arguments. The first is the string to be
# returned by media.pickAFile(), and the second is the string to be
# used as the filename to write to when using show() or explore() on
# a picture. Use "" for either argument if you do not need it.
...
if len(sys.argv) != 3:
    print('This is a modified version of media.py to be used for autograding.')
    print('It requires 2 command line arguments. The first is the string to be')
    print('returned by media.pickAFile(), and the second is the string to be')
    print('used as the filename to write to when using show() or explore() on')
    print('a picture. Use "" for either argument if you do not need it.')
    sys.exit(1)
...
class Picture:
    ...
    def show(self, title = None):
        # MODIFIED FOR GRADING - writes picture to sys.argv[2]
    
        writePictureTo(self, sys.argv[2])
...
def show(picture, title=None):
    """
    MODIFIED FOR GRADING - writes the image to path sys.argv[2]
    """

    writePictureTo(picture, sys.argv[2])
...
def pickAFile(sdir = None):
    """
    MODIFIED FOR GRADING - returns sys.argv[1]
    """
...
def explore(media):
    """
    MODIFIED FOR GRADING - writes pictures to sys.argv[2]
    """
    if isinstance(media, Picture):
        writePictureTo(media, sys.argv[2])
